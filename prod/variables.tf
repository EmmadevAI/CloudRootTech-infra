...
variable "cluster_name" {
  ...
  type        = string
  default     = "prod-cloudtechroot-cluster"
}

variable "rolearn" {
  description = "IAM role ARN to be added to the aws-auth configmap as admin"
  type        = string
  default     = "arn:aws:iam::413026843685:role/terraform-create-role"
}
